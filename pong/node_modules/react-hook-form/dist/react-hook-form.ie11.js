...
function findRemovedFieldAndRemoveListener(fields, handleChange, field, forceDelete) {
  ...
  if ((isRadioInput(ref) || isCheckBoxInput(ref)) && fieldValue) {
    ...
    if (isArray$4(options_1) && options_1.length) {
      ...
      forEach$2(_context = filter$2(options_1).call(options_1, Boolean)).call(_context, function (option, index) {
        var ref = option.ref,
...
var getCheckboxValue = (function (options) {
  if (isArray$4(options)) {
    if (options.length > 1) {
      ...
      var values = map$2(_context = filter$2(options).call(options, function (option) {
...
var compareObject = (function (objectA, objectB) {
  ...
  var objectAKeys = keys$3(objectA);

  var objectBKeys = keys$3(objectB);

  return objectAKeys.length === objectBKeys.length && every$2(objectAKeys).call(objectAKeys, function (key) {
...
var parseErrorSchema = function (error, validateAllFieldCriteria) {
  ...
  return isArray$4(error.inner) ? reduce$2(_context = error.inner).call(_context, function (previous, _a) {
    ...
    var path = _a.path,
        message = _a.message,
        type = _a.type;
    return __assign(__assign({}, previous), path ? previous[path] && validateAllFieldCriteria ? (_b = {}, _b[path] = appendErrors(path, validateAllFieldCriteria, previous, type, message), _b) : (_c = {}, _c[path] = previous[path] || __assign({
      message: message,
      type: type
...
var assignWatchFields = (function (fieldValues, fieldName, watchFields, combinedDefaultValues) {
  ...
  return isUndefined(value) ? get$1(combinedDefaultValues, fieldName) : value;
});
...
function useForm(_a) {
  ...
  var setDirty = function (name) {
    ...
    if (isFieldArray) {
      ...
      isFieldDirty = getIsFieldsDifferent(getFieldValueByName(fieldsRef.current, fieldArrayName), get$1(defaultValuesRef.current, fieldArrayName));
    }
  ...
  var setInternalValues = React.useCallback(function (name, value, parentFieldName) {
  ...
  var executeSchemaOrResolverValidation = React.useCallback(function (payload) {
    return __awaiter(_this, void 0, void 0, function () {
      var errors, previousFormIsValid, error;
  ...
  function setValue(names, valueOrShouldValidate, shouldValidate) {
    ...
    var isArrayValue = isArray$4(names);

    forEach$2(_context2 = isArrayValue ? names : [names]).call(_context2, function (name) {
      var isStringFieldName = isString(name);
      shouldRender = setInternalValue(isStringFieldName ? name : keys$3(name)[0], isStringFieldName ? valueOrShouldValidate : values$5(name)[0]) || isArrayValue ? true : isFieldWatched(name);
    });
  ...
  handleChangeRef.current = handleChangeRef.current ? handleChangeRef.current : function (_a) {
    var type = _a.type,
        target = _a.target;
    return __awaiter(_this, void 0, void 0, function () {
      var name, fields, errors, field, currentError, error, isBlurEvent, shouldSkipValidation, shouldUpdateDirty, shouldRender, errors_1, previousFormIsValid;
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            if (!shouldValidateSchemaOrResolver) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
  ...
  var validateSchemaOrResolver = React.useCallback(function (values) {
    if (values === void 0) {
      values = {};
    }
  ...
  function setError(name, type, message) {
    ...
    if (isString(name)) {
      setInternalError(__assign(__assign({
        name: name
      }, isObject$1(type) ? {
        types: type,
        type: ''
      ...
      forEach$2(name).call(name, function (error) {
        return setInternalError(__assign({}, error));
      });
  ...
  function watch(fieldNames, defaultValue) {
    ...
    if (isString(fieldNames)) {
      return assignWatchFields(fieldValues, fieldNames, watchFields, (_a = {}, _a[fieldNames] = isDefaultValueUndefined ? get$1(combinedDefaultValues, fieldNames) : defaultValue, _a));
    }
  ...
  function unregister(name) {
    if (fieldsRef.current) {
      ...
      forEach$2(_context4 = isArray$4(name) ? name : [name]).call(_context4, function (fieldName) {
  ...
  function registerFieldsRef(ref, validateOptions) {
    ...
    if (isRadioOrCheckbox ? field && isArray$4(field.options) && find$2(_context5 = filter$2(_context6 = field.options).call(_context6, Boolean)).call(_context5, function (option) {
    ...
    if (type) {
      ...
      field = isRadioOrCheckbox ? __assign({
        options: __spread(field && field.options || [], [{
          ref: ref,
  ...
  var handleSubmit = React.useCallback(function (callback) {
    return function (e) {
      return __awaiter(_this, void 0, void 0, function () {
        var fieldErrors, fields, fieldValues, _a, errors, values, _b, _c, field, name_1, fieldError, e_1_1;
  ...
  var commonProps = {
    ...
    register: React.useCallback(register, [defaultValuesRef.current, defaultValuesAtRenderRef.current]),
...
var useFieldArray = function (_a) {
  ...
  var getDefaultValues = function () {
    return __spread(get$1(fieldArrayDefaultValues.current[getFieldArrayParentName(name)] ? fieldArrayDefaultValues.current : defaultValuesRef.current, name, []));
  };
  ...
  var remove = function (index) {
    ...
    if (readFormStateRef.current.isValid && !validateSchemaIsValid) {
      var fieldIndex = -1;
      var isFound = false;
      var isIndexUndefined_1 = isUndefined(index);
      ...
      while (fieldIndex++ < fields.length) {
        ...
        if (isCurrentIndex || isIndexUndefined_1) {
          isFound = true;
        }
        ...
        for (var key in fields[fieldIndex]) {
          ...
          if (isCurrentIndex || isLast || isIndexUndefined_1) {
